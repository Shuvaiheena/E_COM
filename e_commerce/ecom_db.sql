...
--
-- Name: customer_details; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.customer_details OWNER TO admin;

--
-- Name: customer_details_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
ALTER TABLE public.customer_details_id_seq OWNER TO admin;

--
-- Name: customer_details_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--
...
--
-- Name: product_details_prod_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.product_details_prod_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.product_details_prod_id_seq OWNER TO admin;

--
-- Name: product_details_prod_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.product_details_prod_id_seq OWNED BY public.product_details.prod_id;


--
-- Name: customer_details id; Type: DEFAULT; Schema: public; Owner: admin
--
...
--
-- Name: product_details prod_id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.product_details ALTER COLUMN prod_id SET DEFAULT nextval('public.product_details_prod_id_seq'::regclass);
...
25	Can add customer details	7	add_customerdetails
26	Can change customer details	7	change_customerdetails
27	Can delete customer details	7	delete_customerdetails
28	Can view customer details	7	view_customerdetails
29	Can add product details	8	add_productdetails
30	Can change product details	8	change_productdetails
31	Can delete product details	8	delete_productdetails
32	Can view product details	8	view_productdetails
\.
...
--
-- Data for Name: customer_details; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.customer_details (id, name, email, mobile, address, code, gender, date_created, customer_age, active_state) FROM stdin;
1	heena	heena@gmail.com	\N	pulamenthole, Malappuram	\N	Female	2023-07-11 00:00:00	26	1
2	hanna	hanna@gmail.com	9567177820	pulamenthole, Malappuram	\N	Female	2023-07-11 00:00:00	26	1
\.
...
6	sessions	session
7	e_com_customer	customerdetails
8	e_com_products	productdetails
\.
...
1	contenttypes	0001_initial	2023-07-16 00:34:17.05533+05:30
2	auth	0001_initial	2023-07-16 00:34:19.524344+05:30
3	admin	0001_initial	2023-07-16 00:34:19.81204+05:30
4	admin	0002_logentry_remove_auto_add	2023-07-16 00:34:19.851231+05:30
5	admin	0003_logentry_add_action_flag_choices	2023-07-16 00:34:19.875003+05:30
6	contenttypes	0002_remove_content_type_name	2023-07-16 00:34:19.949777+05:30
7	auth	0002_alter_permission_name_max_length	2023-07-16 00:34:19.971826+05:30
8	auth	0003_alter_user_email_max_length	2023-07-16 00:34:20.014181+05:30
9	auth	0004_alter_user_username_opts	2023-07-16 00:34:20.037515+05:30
10	auth	0005_alter_user_last_login_null	2023-07-16 00:34:20.062215+05:30
11	auth	0006_require_contenttypes_0002	2023-07-16 00:34:20.073873+05:30
12	auth	0007_alter_validators_add_error_messages	2023-07-16 00:34:20.111003+05:30
13	auth	0008_alter_user_username_max_length	2023-07-16 00:34:20.194887+05:30
14	auth	0009_alter_user_last_name_max_length	2023-07-16 00:34:20.239433+05:30
15	auth	0010_alter_group_name_max_length	2023-07-16 00:34:20.25988+05:30
16	auth	0011_update_proxy_permissions	2023-07-16 00:34:20.2818+05:30
17	auth	0012_alter_user_first_name_max_length	2023-07-16 00:34:20.304085+05:30
18	e_com_customer	0001_initial	2023-07-16 00:34:20.318782+05:30
19	sessions	0001_initial	2023-07-16 00:34:20.576004+05:30
20	e_com_products	0001_initial	2023-07-16 09:12:51.649824+05:30
\.
...
COPY public.product_details (prod_id, prod_name, prod_code, prod_date, prod_age, prod_active, customer_id) FROM stdin;
1	Pen	PEN01	2023-07-11 00:00:00	5	1	\N
2	Pen	PEN01	2023-07-11 00:00:00	5	1	\N
4	Hat	HAT01	2023-01-20 00:00:00	177	0	\N
5	Key	KEY01	2023-02-15 00:00:00	151	0	2
6	Key	KEY02	2023-02-15 00:00:00	151	0	2
7	Key	KEY02	2023-07-16 00:00:00	0	1	2
\.
...
--
-- Name: customer_details_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.customer_details_id_seq', 3, true);
...
--
-- Name: product_details_prod_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.product_details_prod_id_seq', 7, true);
...
--
-- Name: customer_details customer_details_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: product_details product_details_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.product_details
    ADD CONSTRAINT product_details_pkey PRIMARY KEY (prod_id);
...
--
-- Name: product_details product_details_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.product_details
    ADD CONSTRAINT product_details_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customer_details(id);
